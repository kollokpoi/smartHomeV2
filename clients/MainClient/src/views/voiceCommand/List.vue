<template>
    <div class="mb-6">
        <h1 class="text-2xl text-font-primary font-bold mb-2">Голосовые команды</h1>
        <p class="text-font-secondary">Управление командами действий</p>
    </div>
    ...
    <div>
        <VoiceCommandTable :voiceCommands="voiceCommands" :loading @deleted="loadVoiceCommands"
            v-memo="[voiceCommands]" />
